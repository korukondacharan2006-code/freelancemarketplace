...
export function LogoIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 32 32" fill="none">
      ...
      <path
        d="M8 20V12h3.2c1.76 0 3.04 1.12 3.04 2.64 0 1.04-.56 1.84-1.44 2.24L15.2 20H12l-1.44-2.8H11.2V20H8zm3.2-4.8h.48c.64 0 1.04-.4 1.04-.96s-.4-.96-1.04-.96H11.2v1.92zm6.4 4.8v-8h3.04c2.24 0 3.76 1.44 3.76 4s-1.52 4-3.76 4H17.6zm3.04-2.4c.96 0 1.52-.64 1.52-1.6s-.56-1.6-1.52-1.6H20v3.2z"
        fill="white"
      />
    </svg>
  )
